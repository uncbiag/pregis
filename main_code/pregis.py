...
parser = argparse.ArgumentParser(description='PCA model for Pathological Image Registration: We provide arguments for user to specify, although the default settings are sufficient for most of the cases.', prog='PRegis', conflict_handler='resolve', usage='python pregis.py -i Input_Image [-m Mask_Name] [-o Output_Name] [-p platform] [-g gamma] [-l lambda] [-c correction] [-v] [-h]')
...
additional_args.add_argument('-a', '--after', metavar='', dest='after_image', help='after operationimage', type=is_file_exist)
